program scenario1_dirichlet
  ! Compile with bc_dirichlet.f90 to enforce Dirichlet boundaries.
  ...
  print *, 'Scenario 1 (Dirichlet) simulation finished.'
  deallocate(u_prev, u_curr)
end program scenario1_dirichlet
